  ...
  return (
    ...
    >
      ...
      <div className=" flex flex-row justify-between mt-4">
        ...
        <a href="https://github.com/sohail300" without rel="noreferrer" target="_blank">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="24"
            height="24"
        ...
        <a href="mailto:sohailatwork10@gmail.com" without rel="noreferrer" target="_blank">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="24"
            height="24"
        ...
        <a href="https://twitter.com/sohail_twts" target="_blank" without rel="noreferrer" className=" ml-5">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="24"
            height="24"
